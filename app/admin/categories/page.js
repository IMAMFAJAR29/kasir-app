...
export default function AdminCategoriesPage() {
  ...
  // Render daftar kategori (checkbox + trash)
  function renderList(cats, prefix = "") {
    return cats.flatMap((c) => [
      <div
        key={c.id}
    ...
    <div className="pt-20 p-6 max-w-6xl mx-auto font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 gap-4">
        <input
          ...
          className="w-full sm:max-w-md border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-green-500"
        />
        <button
