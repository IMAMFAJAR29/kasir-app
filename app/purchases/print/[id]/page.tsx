...
export default function PrintPurchasePage() {
  ...
  if (loading)
    return <div className="p-6 text-gray-500">Memuat data pembelian...</div>;
  if (!data)
    return (
      <div className="p-6 text-red-500">Data pembelian tidak ditemukan.</div>
    );

  // 🔹 Hitung subtotal, pajak, ongkir, dan total akhir
  ...
  return (
    <div id="printArea" className="print-wrapper">
      <div className="max-w-3xl mx-auto p-8 bg-white text-gray-800 print:shadow-none">
        {/* Header */}
        <div className="text-center border-b pb-4 mb-6">
          <h1 className="text-2xl font-bold">LAPORAN PEMBELIAN BARANG</h1>
          <p className="text-sm text-gray-600">Nomor: {data.purchaseNumber}</p>
        </div>
